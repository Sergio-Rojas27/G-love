...
<form action="" method="POST" class="form-todo" enctype="multipart/form-data">
    <div class="container-left">
        <label for="avatar">
            <input required type="file" <?php echo($viendo ? 'readOnly' : '')?> class="img-perfil-p" name="avatar" id="avatar" accept="image/*" required>
    ...
    <div class="container-form" style="padding-left: 0;">
            ...
            <label for="im1">
                <input required <?php echo($viendo ? 'readOnly' : '')?> type="file" class="upload-button-styled" name="fotos[]" id="im1" accept="image/*" required>
            ...
            <label for="im2">
                <input required <?php echo($viendo ? 'readOnly' : '')?> type="file" class="upload-button-styled" name="fotos[]" id="im2" accept="image/*" required>
